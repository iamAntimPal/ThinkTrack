...
def insert_entry_from_recurring(recurring: dict):
    """
    Creates a new entry from recurring transaction data.
    """
    from datetime import datetime
    entry = Entry(recurring['user_id'], recurring['type'], recurring['amount'], 
                  recurring['currency'], recurring['category'], datetime.today().strftime('%Y-%m-%d'),
